...
| **ItemForceIntoChest**             | `Chest` (目标箱子), `Item` (被强制放入的物品), `Player` (触发此操作的玩家)                                                                                                                                                                            | 物品被快速堆叠放入箱子时触发         |
...
| **PlayerUpdatePhysics**            | `Player` (玩家实例)                                                                                                                                                                                                                   | 玩家物理状态更新时触发, 可能已废弃     |
...
| **ServerConnect**                  | `Who` (尝试连接的玩家索引)                                                                                                                                                                                                                 | 玩家尝试连接服务器时触发           |
| **ServerJoin**                     | `Who` (玩家的索引)                                                                                                                                                                                                                     | 玩家成功加入服务器时触发           |
| **ServerLeave**                    | `Who` (离开的玩家索引)                                                                                                                                                                                                                   | 玩家离开服务器时触发             |
| **ServerChat**                     | `Who` (发送消息的玩家索引), `Text` (聊天内容), `CommandId` (命令类型, 聊天为Text)                                                                                                                                                                     | 服务器处理聊天消息前触发           |
