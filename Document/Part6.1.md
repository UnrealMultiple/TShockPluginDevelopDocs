...
## 解析数据包结构
### 数据包文档
你可以在[Part6.5.1 数据包参考表格](Document/Part6.5.1.md)找到相关数据包结构(目前表格未完善)
...
### 偷看文档
这里有两个可选的文档
1. [Part6.5.1 数据包参考表格](Document/Part6.5.1.md)
 - 优点: 大多是最新的结构
 - 缺点: 覆盖不完整(等待填充)
 例如: 没有收录52
...
```
> [!NOTE]
> 关于Main.netMode, 你可以查看文档: [网络模式](Document/Part6.5.2.md#网络模式)
